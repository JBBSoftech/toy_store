...
// MongoDB connection
mongoose.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/toy_store_app', {
...
app.get('/api/app-config', async (req, res) => {
  try {
    ...
    const config = {
      adminId: '695f6ef0ea4dd58bb956c8cb',
      shopName: 'Toy store',
...
app.listen(PORT, () => {
  console.log(`Toy store Backend Server running on port ${PORT}`);
});
